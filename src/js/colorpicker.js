    ...
    $.fn.colorpicker = function (options) {
        ...
        function initColor() {
            ...
            colorTable = '<table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">' +
                ...
                '<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> | <a href="javascript:void(0);" id="_affirm">确认</a></td></tr></table></td></table>' +
